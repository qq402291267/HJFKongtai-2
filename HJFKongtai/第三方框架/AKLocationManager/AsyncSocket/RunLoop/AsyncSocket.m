...
**/
@interface MAsyncSpecialPacket : NSObject
{
  @public
...
@implementation MAsyncSpecialPacket
...
- (NSString *)description
{
	...
	if (theCurrentRead == nil || [theCurrentRead isKindOfClass:[MAsyncSpecialPacket class]])
	...
	if (theCurrentWrite == nil || [theCurrentWrite isKindOfClass:[MAsyncSpecialPacket class]])
...
- (void)maybeDequeueRead
{
	...
	if((theCurrentRead == nil) && (theReadStream != NULL))
	{
		if([theReadQueue count] > 0)
		{
			...
			if([theCurrentRead isKindOfClass:[MAsyncSpecialPacket class]])
			{
...
- (void)maybeDequeueWrite
{
	...
	if((theCurrentWrite == nil) && (theWriteStream != NULL))
	{
		if([theWriteQueue count] > 0)
		{
			...
			if([theCurrentWrite isKindOfClass:[MAsyncSpecialPacket class]])
			{
				// Attempt to start TLS
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	MAsyncSpecialPacket *packet = [[MAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	{
		MAsyncSpecialPacket *tlsPacket = (MAsyncSpecialPacket *)theCurrentRead;
