...
//康泰
//0100ffff ffffffff 08000002 a1d26a12 81
+ (NSData *)tcpProtocolDataWithData:(NSData *)data index:(UInt16)index deviceinfo:(DevicePreF *)deviceinfo
{
    ...
    if (deviceinfo) {
        ...
        shadow[6] = deviceinfo.deviceTypevalue;
...
//    protocolDataWithData
    return [self tcpProtocolDataWithData:cmddata index:index deviceinfo:nil];
//    return [self protocolDataWithData:cmddata index:index key:nil];
}
